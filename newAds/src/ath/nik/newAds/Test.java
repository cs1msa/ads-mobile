...
public class Test
{
  ...
  // keywords method
	...
	public void getDataFromXML(Context con, ProgressDialog progressDialog) throws XmlPullParserException, IOException{
		...
		if(!flag){
			progressDialog.setMessage("Ληψη δεδομένων");
